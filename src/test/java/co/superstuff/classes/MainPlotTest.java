...
class MainPlotTest {
    ...
    @DisplayName("Load a MainPlot without chunks")
    @Test
    public void loadWithoutChunks() {
        ...
        MainPlot mainPlot = MainPlot.fromMap(map);
    ...
    @DisplayName("Load a MainPlot with chunks")
    @Test
    ...
    @DisplayName("dump a MainPlot object")
    @Test
    public void dumpAsMap() {
        ...
        MainPlot mainPlot = new MainPlot(100, -100, 10, "id-1000", chunks);
